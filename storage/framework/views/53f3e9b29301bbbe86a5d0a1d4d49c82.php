...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        ...
        <ul class="navbar-nav ms-auto">
            <li class="nav-item">
                <a class="nav-link btn-menu" id="btn-login" href="login">Entrar</a>
            </li>
            <li class="nav-item">
...
<?php /**PATH C:\Users\CésarDuarte\Documents\GitHub\PlataformaAdocao\resources\views/layouts/main.blade.php ENDPATH**/ ?>