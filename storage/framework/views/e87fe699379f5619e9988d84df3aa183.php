...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Pet Projeto'); ?></title>
    ...
    <?php echo $__env->yieldContent('head'); ?> <!-- Permite incluir algo extra no <head> se necessário -->

</head>
<body>
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-light custom-navbar">
    <a class="navbar-brand" href="<?php echo e(route(name: 'home')); ?>">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route(name: 'home')); ?>">Home</a>
            </li>
            <li class="nav-item">
        ...
        <ul class="navbar-nav ms-auto">
            <li class="nav-item">
                <a class="nav-link btn-menu" id="btn-login" href="<?php echo e(route('login')); ?>">Entrar</a>
            </li>
            <li class="nav-item">
                <a class="nav-link btn-menu" id="btn-parceiro" href="#">Seja um parceiro</a>
            </li>
            <li class="nav-item">
                <a class="nav-link btn-adotar" href="#">Quero Adotar</a>
            </li>
        </ul>
    </div>
...
<?php /**PATH D:\projetos\PlataformaAdocao\resources\views/layouts/main.blade.php ENDPATH**/ ?>