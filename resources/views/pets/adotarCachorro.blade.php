...
@section('content')
    ...
    @php
        ...
        $filtros = [
            ...
            'generos' => $cachorros->pluck('genero')->filter()->unique()->sort()->values(),
            'idades'  => $cachorros->pluck('idade')->filter()->unique()->sort()->values(),
        ];
    @endphp
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const aplicaFiltros = () => {
                ...
                cards.forEach((card) => {
                    ...
                    const coincideEspecie = cardEspecie === 'cachorro';
