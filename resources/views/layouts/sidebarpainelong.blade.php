...
<head>
  ...
  position: sticky; 
  top: 0;
  z-index: 100; /* maior que o da sidebar */
}
      /* Sidebar */
      .sidebar {
        position: fixed; top: 1rem; left: 0; bottom: 0;
        z-index: 10;
        background-color: black;
        width: 240px; background:#2e2e2e; padding-top:64px; overflow-y:auto;
        transform: translateX(-100%); transition: transform .3s; z-index:1040;
      }
      ...
      .sidebar a { 
        ...
        z-index 10; }
      .sidebar a:hover { background:#4b6374; color:#fff; }
      .active-link { background:#2e5672 !important; color:#fff !important; font-weight:700; }

      .sidebar-backdrop.show { opacity:1; pointer-events:auto; }

      @media (min-width: 992px){
        body.push-main #main-content { margin-left:240px; transition: margin-left .3s; }
      }
    </style>
</head>
...
<nav class="navbar navbar-expand-lg navbar-light custom-navbar">
    ...
    @auth('ong')
      <button id="btn-toggle-sidebar" class="btn btn-dark me-2" type="button" aria-label="Abrir menu lateral">☰</button>
    @endauth
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        ...
        <ul class="navbar-nav ms-auto">
            ...
            @elseif(auth('ong')->check())
              <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="menuOng" role="button"
                      data-bs-toggle="dropdown" aria-expanded="false">
