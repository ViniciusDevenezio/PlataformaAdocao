                ...
                <form action="{{ route('adotantes.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="cpf" name="cpf" class="form-control" maxlength="11" pattern="\d{11}"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="nascimento" name="nascimento" class="form-control"
                                placeholder="dd/mm/aaaa" value="{{ old('nascimento') }}" required>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div id="cadastro-celular" class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="celular" name="celular" class="form-control"
                                placeholder="(00) 00000-0000" value="{{ old('celular') }}" required>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="lgpd-box mt-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="lgpd_aceite" name="lgpd_aceite"
                                value="1" required>
                    ...
                    <div id="cadastro-botao" class="text-center">
